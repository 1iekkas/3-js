...
export default {
  ...
  methods: {
    ...
    init() {
      ...
      objLoader.load("static/mustang/control.glb", (gltf) => {
        let obj = gltf.scene;
      ...
      objLoader.load("static/mustang/wheel.glb", (gltf) => {
        let obj = gltf.scene;
        obj.traverse(function (child) {
          if (child.isMesh) {
            child.material.emissive = child.material.color;
      ...
      objLoader.load("static/mustang/skeleton.glb", (gltf) => {
        let obj = gltf.scene;
        obj.traverse(function (child) {
          if (child.isMesh) {
            child.material.emissive = child.material.color;
      ...
      objLoader.load("static/mustang/chassis.glb", (gltf) => {
        let obj = gltf.scene;
        obj.traverse(function (child) {
          if (child.isMesh) {
            child.material.emissive = child.material.color;
      ...
      objLoader.load("static/mustang/windows.glb", (gltf) => {
        let obj = gltf.scene;
        obj.traverse(function (child) {
          if (child.isMesh) {
            child.material.emissive = child.material.color;
      ...
      objLoader.load("static/mustang/body.glb", (gltf) => {
        let obj = gltf.scene;
        obj.traverse(function (child) {
          if (child.isMesh) {
            child.material.emissive = child.material.color;
