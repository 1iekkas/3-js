  ...
  methods: {
    ...
    init() {
      ...
      this.camera.position.set(10, 50, 200);
       ...
       // 创建平面
      const planeGeometry = new THREE.BoxGeometry(8,20,56); // 生成平面几何
      ...
      //planeMesh.position.set(30, 30, 0)
      /* planeMesh.translateX(50);
      planeMesh.position.x = 50 */

      //console.log(planeMesh)
      //planeMesh.position.copy(model.position)
      //planeMesh.position.y = 0
      //planeMesh.translateX(30)
      //planeMesh.rotation.y = -Math.PI / 4; //绕X轴旋转90度
      this.group = new THREE.Group()
      this.group.position.set(4, 10, 0)
      this.group.add(planeMesh)  
      
      /* console.log(planeMesh.getWorldPosition(new THREE.Vector3()), planeMesh.position)
      //planeMesh.rotateY(-Math.PI / 4)
      //planeMesh.rotation.z = -50
      this.scene.add(group); // 添加到场景中 */
      this.group.rotateY(-Math.PI / 4)
      //planeMesh.rotation.y = Math.PI / 2 
      //planeMesh.position.set(-28, 0, 0);
      this.scene.add(this.group)
      console.log(box.expandByObject(this.group))
      console.log(this.group.getWorldPosition())
      /* planeMesh.position.set(28, 28, 28); */
      //this.group.center()
      // 渲染器
